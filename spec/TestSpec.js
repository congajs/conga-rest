...
describe("Kernel", () => {
    ...
    it("should load a one to one relationship", (done) => {
        ...
        request({
            ...
            uri: 'http://localhost:5555/api/articles/?filter[reference_id]=5',
            method: 'GET',
            json: true,
            headers: {
                'content-type': 'application/json'
        ...
        request({
            ...
            request({
                ...
                request({
                    ...
                    expect(body.data.relationships.comments.data).not.toBeUndefined();
                    expect(body.data.relationships.comments.data).not.toBeNull();
                    expect(body.data.relationships.comments.data.length).toEqual(1);
    ...
    fit("should update a one to one relationship", (done) => {
        ...
        request({
            ...
            request({
                ...
                request({
                    ...
                    expect(body.data.relationships.author.data).not.toBeUndefined();
                    expect(body.data.relationships.author.data).not.toBeNull();
                    expect(body.data.relationships.author.data.id).toEqual(userId);
