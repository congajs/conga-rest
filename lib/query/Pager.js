...
module.exports = class Pager {
     ...
     */
    getFirst() {
        throw new Error('You must implement Pager.getFirst()');
    }
     ...
     */
    isNextToLastPage() {
        throw new Error('You must implement Pager.isNextToLastPage()');
    }
     ...
     */
    getMetaInfo() {
        throw new Error('You must implement Pager.getMetaInfo()');
    }
}
