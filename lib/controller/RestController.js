...
module.exports = class RestController extends Controller {
    ...
    sendInternalServerError(res, error) {
        ...
        return res.error(this.buildErrorResponse({
            ...
            // NOTE: to avoid empty error objects in the response, we need enumerable properties
            errors: [Object.assign({}, error, {stack: error.stack, message: error.message})]
        }, 500, error.message || null));
    }
