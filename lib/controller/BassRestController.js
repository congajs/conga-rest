...
module.exports = class BassRestController extends RestController {
    ...
    /**
     * Load / validate relationships from incoming request data and attach to resource
     *
     * @param  {Object} resource
     * @param  {Object} data
     * @return {Promise}
     */
    attachRelationshipsToResource(req, res, session, resource, relationships) {
