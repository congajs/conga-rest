...
module.exports = class BassRestController extends RestController {
    ...
    list(req, res) {
        ...
        this.modifyListQuery(req, res, query).then(() => {
            ...
            return manager.findByQuery(this.model, query);
            ...
            return new Promise((resolve, reject) => {
                ...
                pager.setMaxResults(documents.totalNum);

                try {
                    res.return(this.buildReturnData(req, res, documents.data, pager));
                } catch (err) {
                    reject(err);
                }
    ...
    find(req, res) {
        ...
        this.modifyFindConditions(req, res, conditions).then(() => {
            ...
            return manager.findOneBy(this.model, conditions);
            ...
            res.return(this.buildReturnData(req, res, document));
            ...
            this.container.get('validator').validate(resource).then(() => {
                ...
                this.onCreate(req, res, resource).then(() => {
                    ...
                    manager.flush().then(() => {
                        ...
                        res.return(this.buildReturnData(req, res, resource));
