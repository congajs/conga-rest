...
module.exports = class RestManager {
    ...
    createSpecification(config) {
        ...
        // console.log(this.container.get('conga.rest.resource.registry'))
        // process.exit();
        ...
        const serializer = this.instantiateService(
            ...
            [
                ...
                this.instantiateService(c.marshaller)
            ]
        );
        ...
        const specification = new RestSpecification(
            ...
            this.instantiateService(c.query.filtering, [c.query.source, serializer]),
