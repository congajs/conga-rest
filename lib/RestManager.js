...
module.exports = class RestManager {
    ...
    createSpecification(config) {
        ...
        const errorFormatter = this.instantiateService(c.error.formatter, [this.container.get('conga.rest.mapper')]);
        ...
        const specification = new RestSpecification(
            ...
            this.instantiateService(c.query.includes, [c.query.source, this.container.get('conga.rest.mapper')]),
            this.instantiateService(c.error.handler, [errorFormatter])
        );
        ...
        this.container.get('conga.rest.router').setHasAbsoluteUrls(config.specification['absolute-urls']);
    }
