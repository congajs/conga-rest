...
module.exports = class RestAttributeAnnotation extends Annotation {
    ...
    init(data) {
        ...
        /**
         * Specify if the target property can be written through REST
         *
         * @type {Boolean}
         */
        this.write = typeof data.write === 'undefined' ? true : data.write;
        ...
        /**
         * Specify a format when applicable (i.e. date format)
         *
         * @type {Boolean}
         */
