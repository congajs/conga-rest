...
export default Vue.extend({
    ...
    template: `
        ...
        <div class="">
            ...
            <div>
                    ...
                    <div class="field-body">
                        <div class="field">
                            <div class="control" v-for="method in methods">
                                <input type="checkbox" :id="method.name" :value="method.name" v-model="api.allowedMethods">
                ...
                <a v-on:click="create" class="button is-primary">Create API</a>
    ...
    created: function() {
        ...
        this.$http.get('_conga/api/rest/bundles').then((response) => {
            ...
            this.api.bundle = this.bundles[0].name;
        }, (response) => {
